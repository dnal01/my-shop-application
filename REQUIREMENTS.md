...
- Нічого не має видалятися а деактивовуватися.
- Повинне бути розділення між активними моделями та деактивованими.
- Деативовані моделі мають переставати брати участь у деякій аналітиці (такій як рекомендації по замовленню товарів не мають враховувати деактивовані товари)
...
- bank account properties:
  - Відсоток відрахувань банку за зарахування
  - TBD
...
- Розширення методів оплати до безготівкових (Кредитними картками) (dumy selection option when on paymant screen)
- Створення нової доменної моделі клієнти із властивостями та поведінкою
- Кошти з безготівкового та готівкового рахунків мають сумуватися, що б бачити загальну статистику коштів.
- Можливість налаштувати місячні автоматичні транзакції витрат та доходів (наприклад кожного місяця плата за аренду однакова).
...
- оплата безготівкою звичайни варіант вибору. Кошти зараховуються на безготівковий рахунок
- оплата бонусами клієнтів. При доданні клієнта до замовлення можна списати його бонуси у розмірі 1 до 1. Ціна всього замовлення зменшиться на суму списаних бонусів. При цьому ціна змінить свій колір щоб вказати на застосування бонусів.
- Приймати замовлення з інтернет магазину
- Відправляти електронний лист після оплати замовлення клієнтом
- При успішній оплаті у разі оплати банківською картою, відняти відсоток за обслуговування
