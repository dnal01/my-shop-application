...
- Наявність бізнес аналітики.
- Мати Intelligence лоігку яка аналізує та виводить дані: наприклад рекомендовані дії або попередження.
- Мати інтернет магазин
- Розширення методів оплати до безготівкових та інтеграції з банком та податковою та смс/месенджери службами
- 
...
- Розширення на права дуступу до окремих модулів
- Управління знижками, акціями та бонусами.
- Розширення управління клієнтами
