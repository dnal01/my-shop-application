...
- TO DO Побудувати логіку, як роль буде інтегруватися з бізнес логікою та UI.

## MVP v2

Requirements:

- Розширення методів оплати до безготівкових (Кредитними картками)
- Інтеграції з банком та податковою (optional)
- Управління знижками, акціями та бонусами
...
- При оплаті замовлення вибрати опцію чи відправити електроний лист чи смс клієнту після оплати. Та відправити trigger серверу
- Сервер має мати лгіку відправляє повідомлення після тригеру від оплати замовлення від клієнта
